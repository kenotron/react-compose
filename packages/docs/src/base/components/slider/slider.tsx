...
export const useSliderSlots: (props: SliderProps) => SliderSlotProps = (
  props: SliderProps
) => {
  const {
    min,
  ...
  const resolvedProps = {
    ...
    rail: {
      ref: trackRef,
      ...((props && props.slotProps && props.slotProps.rail) || {})
    },
    track: {
      style: {
        width: `${percentage}%`
      },
      ...((props && props.slotProps && props.slotProps.track) || {})
    },
    thumb: {
      style: {
        left: `${percentage}%`
      },
      ...((props && props.slotProps && props.slotProps.thumb) || {})
    }
  };
